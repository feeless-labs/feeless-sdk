...
export interface BalancerSdkSorConfig {
  ...
  tokenPriceService: 'api' | 'coingecko' | 'subgraph' | TokenPriceService | 'static';
...
export interface BalancerNetworkConfig {
  ...
  pools: {
    FLSIOTA?: PoolReference;
    ETHBTC?: PoolReference;
    FLSDAI?: PoolReference;
    IOTABTC?: PoolReference;
    IOTAETH?: PoolReference;
    USDCDAI?: PoolReference;
    USDTUSDC?: PoolReference;
  };
